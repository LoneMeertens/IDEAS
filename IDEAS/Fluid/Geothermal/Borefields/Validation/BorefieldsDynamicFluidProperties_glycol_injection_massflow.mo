...
model BorefieldsDynamicFluidProperties_glycol_injection_massflow
...
protected
  Modelica.Blocks.Sources.RealExpression m_flow_expr(y=m_flow_nominal*0.5*(1 +
        sin(2*Modelica.Constants.pi*freq*time + phase)))
    "mass flow through borefield"
...
equation
  ...
  connect(TUTubIn20.port_a, sou20.ports[1])
    annotation (Line(points={{-60,-20},{-72,-20}}, color={0,127,255}));
  connect(m_flow_expr.y, sou10.m_flow_in) annotation (Line(points={{-107,8},{-102,
          8},{-102,68},{-94,68}}, color={0,0,127}));
  connect(m_flow_expr.y, sou15.m_flow_in) annotation (Line(points={{-107,8},{-102,
          8},{-102,28},{-94,28}}, color={0,0,127}));
  connect(m_flow_expr.y, sou20.m_flow_in) annotation (Line(points={{-107,8},{-102,
          8},{-102,-12},{-94,-12}}, color={0,0,127}));
  connect(m_flow_expr.y, sou30.m_flow_in) annotation (Line(points={{-107,8},{-102,
          8},{-102,-52},{-94,-52}}, color={0,0,127}));
...
end BorefieldsDynamicFluidProperties_glycol_injection_massflow;
