...
model BorefieldsDynamicFluidProperties_water_injection_massflow
...
equation
  ...
  connect(TUTubIn20.port_a, sou20.ports[1])
    annotation (Line(points={{-60,-20},{-72,-20}}, color={0,127,255}));
  connect(m_flow_expr.y, sou10.m_flow_in) annotation (Line(points={{-111,6},{-102,
          6},{-102,68},{-94,68}}, color={0,0,127}));
  connect(m_flow_expr.y, sou15.m_flow_in) annotation (Line(points={{-111,6},{-102,
          6},{-102,28},{-94,28}}, color={0,0,127}));
  connect(m_flow_expr.y, sou20.m_flow_in) annotation (Line(points={{-111,6},{-102,
          6},{-102,-12},{-94,-12}}, color={0,0,127}));
  connect(m_flow_expr.y, sou30.m_flow_in) annotation (Line(points={{-111,6},{-102,
          6},{-102,-52},{-94,-52}}, color={0,0,127}));
...
end BorefieldsDynamicFluidProperties_water_injection_massflow;
