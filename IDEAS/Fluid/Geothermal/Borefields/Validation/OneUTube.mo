...
model OneUTube "Borefield model containing single U-tube boreholes"
  extends IDEAS.Fluid.Geothermal.Borefields.BaseClasses.PartialBorefield(
    redeclare IDEAS.Fluid.Geothermal.Borefields.Validation.BaseClasses.OneUTube borHol);
